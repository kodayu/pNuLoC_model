...
from keras.layers import Concatenate, MaxPooling1D, BatchNormalization, Add, Flatten
...
max_len = 2000
train_data, train_label = read_data("../0.datadeal/eukaryota.whole.fixedlength.dataset")
...
history1 = model1.fit(train_ohe, y_train, batch_size=64, epochs=7)
...
roc_file(t_score, t_label, num="alldata")

model1.save_weights('../3.model/model.alldata.h5')
json = open('../3.model/model.alldata.json',"w")
json.write(model1.to_json())
json.close()

loss = history1.history["loss"]
np.savetxt('../3.model/model.alldata.loss.txt',loss)
