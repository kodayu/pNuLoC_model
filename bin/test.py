...
max_len = 2000
file1 = '../0.datadeal/eukaryota.train.fixedlength1.dataset'
...
file2 = '../0.datadeal/eukaryota.valid.fixedlength1.dataset'
...
history2 = model2.fit(train_ohe, y_train, batch_size=32, epochs=50, validation_data=(val_ohe, y_vali),callbacks=cb)
