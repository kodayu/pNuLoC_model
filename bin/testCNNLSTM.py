...
train_data = train_data[:100]+train_data[-100:]
train_label = train_label[:100]+train_label[-100:]
...
vali_data = vali_data[:100]+vali_data[-100:]
vali_label = vali_label[:100]+vali_label[-100:]
...
cb = [EarlyStopping(monitor='val_accuracy',patience=1)]
...
model1.save_weights('../3.model/model.CNNLSTM.h5')
json = open('../3.model/model.CNNLSTM.json',"w")
